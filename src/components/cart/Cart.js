...
const Cart = () => {
  ...
  const selectedAll = cart.selectedAll || false;
                      ...
                      >
                        ...
                        <div class="flex-1 min-w-0">
                          ...
                          <div class="flex items-center mt-2">
                            <button
                              class="cart-quantity-decrease-btn w-7 h-7 flex items-center justify-center border border-gray-300 rounded-l-md bg-gray-50 hover:bg-gray-100"
                              data-product-id="${item.id}"
                            >
                            ...
                            <input
                              ...
                              value="${item.quantity}"
                              min="1"
                              class="cart-quantity-input w-12 h-7 text-center text-sm border-t border-b border-gray-300 focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                              data-product-id="${item.id}"
                            />
                            <button
